    ...
    return (
      <section className="contact">
        <h3>
          ...
          <span className="gradient-text">developer</span> with my skillset?
        </h3>
        <p>
          Or do you just have some questions for me? Don't hesitate to send me
          an email.
        </p>
        <a
          className="email gradient-text secondary"
          href="mailto:manaustransez@hotmail.com"
        >
          manaustransez@hotmail.com
        </a>
