  ...
  render() {
    return (
      <section className="about">
        ...
        <p>
          Right now I really like the so called{" "}
          <span title="MongoDB, Express, React, Node">MERN</span> stack.
        </p>
        <p>
          This JavaScript development stack is a combination of the following
          technologies:
        </p>
